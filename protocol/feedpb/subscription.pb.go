...
var file_feedpb_subscription_proto_rawDesc = string([]byte{
...
var (
	...
	file_feedpb_subscription_proto_rawDescData []byte
)

func file_feedpb_subscription_proto_rawDescGZIP() []byte {
	file_feedpb_subscription_proto_rawDescOnce.Do(func() {
		file_feedpb_subscription_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_feedpb_subscription_proto_rawDesc), len(file_feedpb_subscription_proto_rawDesc)))
	})
...
func file_feedpb_subscription_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_feedpb_subscription_proto_rawDesc), len(file_feedpb_subscription_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
