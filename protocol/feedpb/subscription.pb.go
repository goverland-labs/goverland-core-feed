...
var file_feedpb_subscription_proto_goTypes = []interface{}{
...
func file_feedpb_subscription_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_feedpb_subscription_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_feedpb_subscription_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
